...
from api.pagination import LimitParam, MessageLimitParam, OffsetParam
...
async def list_sessions(
    ...
    return await session_service.list_for_agent(
...
async def get_session_messages(
    ...
    return await message_service.list_for_session(
